...
from cadaster.gis.utils import ImageSize


class Raster:
    def __init__(self, raster_path: str, raster_crs: Optional[Union[str, int]] = 'epsg:3004'):
        ...
        self.wsg2crs = pyproj.Transformer.from_crs(4326, raster_crs, always_xy=True).transform
        self.crs2wsg = pyproj.Transformer.from_crs(raster_crs, 4326, always_xy=True).transform
        self._image = None
